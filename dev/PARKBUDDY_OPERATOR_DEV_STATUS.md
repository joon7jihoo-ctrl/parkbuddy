...
## 2026-06-15 - Score Input Sticky Summary Fix

Status: completed

Summary:

- Added mobile sticky summary behavior to the score input screen.
- Reduced mobile spacing slightly for denser score-entry operation.
- Kept tablet/desktop summary static to avoid unnecessary sticky UI.
- Preserved score-card layout and save logic.
