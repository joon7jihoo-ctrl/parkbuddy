...
const root = 'C:\\parkbuddy';

const pagePath = join(root, 'src', 'app', '(app)', 'admin', 'rounds', 'calendar', 'page.tsx');
const reportPath = join(root, 'dev', '2026-06-13-round-calendar-page-report.md');
...
const report = `# ParkBuddy 개발보고서 - 라운드 월별 일정 페이지
...
mkdirSync(join(root, 'src', 'app', '(app)', 'admin', 'rounds', 'calendar'), { recursive: true });
